...
class Visualizer():
    ...
    def __init__(self, name, display_winsize=400, display_port=8098):
        ...
        if self.use_html:  # create an HTML object at <checkpoints_dir>/web/; images will be saved under <checkpoints_dir>/web/images/
            self.web_dir = os.path.join("observations", name, 'web')
    ...
    def display_current_results(self, image_numpy):
