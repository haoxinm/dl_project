...
# -----------------------------------------------------------------------------
_C = CN()
_C.BASE_TASK_CONFIG_PATH = "/root/dl_project/habitat-api/configs/tasks/pointnav.yaml"
...
# -----------------------------------------------------------------------------
_C.ORBSLAM2 = CN()
_C.ORBSLAM2.SLAM_VOCAB_PATH = "/root/dl_project/habitat-api/habitat_baselines/slambased/data/ORBvoc.txt"
_C.ORBSLAM2.SLAM_SETTINGS_PATH = (
    "/root/dl_project/habitat-api/habitat_baselines/slambased/data/mp3d3_small1k.yaml"
)
