...
_C.SIMULATOR.SCENE = (
    "/root/dl_project/data/scene_data/gibson/Adrian.glb"
)
...
_C.SIMULATOR.HABITAT_SIM_V0.PHYSICS_CONFIG_FILE = (
    "/root/dl_project/habitat-sim/data/default.phys_scene_config.json"
)
# -----------------------------------------------------------------------------
# PYROBOT
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
_C.DATASET = CN()
_C.DATASET.TYPE = "PointNav-gibson_v2"
_C.DATASET.SPLIT = "val_mini"
_C.DATASET.SCENES_DIR = "/root/dl_project/data/scene_data"
_C.DATASET.CONTENT_SCENES = ["*"]
_C.DATASET.DATA_PATH = (
    "/root/dl_project/data/PointNav-gibson_v2/{split}.json.gz"
)
